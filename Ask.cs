...
namespace Signaux
{
    public class Ask : Signal
    {
        ...
        public Ask(Feed data, double value = 0, string name = "", bool isCalculated = false, bool isValid = false)
        {
            this.data = data;
            this.value = value;
            this.name = name;
        ...
        public override double Value()
        {
            ...
            cut[5] = cut[5].Replace('.', ','); //Rendre possible la conversion en double
            return Convert.ToDouble(cut[5]); //On return le Ask de la ligne donnée par le data.data.setCurseur()
        }
