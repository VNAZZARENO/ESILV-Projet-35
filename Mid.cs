...
namespace Signaux
{
    public class Mid : Signal
    {
        ...
        public override double Value()
        {
            ...
            cut[7] = cut[7].Replace('.', ','); //Rendre possible la conversion en double
            return Convert.ToDouble(cut[7]); //On return le Ask de la ligne donnée par le data.data.setCurseur()
        }
